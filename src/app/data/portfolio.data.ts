...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    title: 'Frontend',
    icon: 'palette',
    skills: ['Angular','TypeScript','JavaScript','NgRx','RxJS','HTML5','SCSS','Material UI','Tailwind CSS','Bootstrap','Responsive UI','Chart.js','Prompt AI','Embedding APIs'],
  },
  {
    id: 'backend',
    title: 'Backend',
    icon: 'dns',
    skills: ['.NET Core','C#','REST APIs','MySQL','CI/CD','Entity Framework Core','Authentication','Authorization','Microservices','Swagger','WebSockets','Elasticsearch' ],
  },
  {
    id: 'tools',
    title: 'Tools & DevOps',
    icon: 'construction',
    skills: ['Azure','GitHub Actions','Azure DevOps','Git','VS Code','Visual Studio','Postman','Linux','Jira','Cursor'],
  },
];
...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    technologies: ['Angular 17+', 'TypeScript', 'JavaScript', '.NET Core', 'SQL Server', 'RxJS', 'NgRx', 'AG Grid', 'REST API', 'Prompt AI', 'Embedding APIs', 'Elasticsearch', 'Chart.js',
    ],
  },
  {
    name: 'Super Highway',
  ...
  },
  {
    ...
    technologies: ['Angular 5', 'TypeScript', 'JavaScript', '.NET Core', 'MySQL', 'RxJS', 'NgRx', 'Azure DevOps', 'REST API', 'Angular Material', 'JWT'],
  },
  {
